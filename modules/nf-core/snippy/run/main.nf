...
conda_tools   = "bioconda::braseqtb-variants=1.0.2"
...
process SNIPPY_RUN {
    ...
    container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/braseqtb-variants:1.0.2--hdfd78af_0' :
        'quay.io/biocontainers/braseqtb-variants:1.0.2--hdfd78af_0' }"
