...
conda_tools   = "bioconda::braseqtb-teton=1.0.2"
...
process KRAKEN2 {
    ...
    container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/braseqtb-teton:1.0.2--hdfd78af_0' :
        'quay.io/biocontainers/braseqtb-teton:1.0.2--hdfd78af_0' }"
