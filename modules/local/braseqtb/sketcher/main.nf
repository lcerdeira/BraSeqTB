...
conda_tools    = "bioconda::braseqtb-sketcher=1.0.1"
...
process SKETCHER {
    ...
    container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/braseqtb-sketcher:1.0.1--hdfd78af_0' :
        'quay.io/biocontainers/braseqtb-sketcher:1.0.1--hdfd78af_0' }"
