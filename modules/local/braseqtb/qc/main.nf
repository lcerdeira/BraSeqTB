...
conda_tools    = "bioconda::braseqtb-qc=1.0.2"
...
process QC {
    ...
    container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/braseqtb-qc:1.0.2--hdfd78af_0' :
        'quay.io/biocontainers/braseqtb-qc:1.0.2--hdfd78af_0' }"
