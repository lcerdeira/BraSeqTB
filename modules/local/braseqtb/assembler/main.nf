...
conda_tools    = "bioconda::braseqtb-assembler=1.0.4"
...
process ASSEMBLER {
    ...
    container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/braseqtb-assembler:1.0.4--hdfd78af_0' :
        'quay.io/biocontainers/braseqtb-assembler:1.0.4--hdfd78af_0' }"
