...
def check_input_fofn() {
    ...
    if (error) {
        ...
        log.error 'See "braseqtb prepare . --examples" for multiple example FOFNs'
        log.error 'Exiting'
        exit 1
    } else {
