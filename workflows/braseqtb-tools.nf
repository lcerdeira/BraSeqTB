...
========================================================================================
*/
include { collect_samples; collect_local_files } from '../lib/nf/braseqtb_tools'
...
WorkflowbraseqtbTools.initialise(workflow, params, log, schema_filename=SCHEMAS)
...
include { ANNOTATE_GENOME } from '../modules/local/braseqtb/annotate_genome/main'
include { ASSEMBLE_GENOME } from '../modules/local/braseqtb/assemble_genome/main'
include { BLAST } from '../modules/local/braseqtb/blast/main'
include { MAPPING_QUERY } from '../modules/local/braseqtb/mapping_query/main'
include { MINMER_QUERY } from '../modules/local/braseqtb/minmer_query/main'
*/
...
if (params.wf == 'merlin') include { DATASETS } from '../modules/local/braseqtb/datasets/main'
...
========================================================================================
*/
workflow braseqtbTOOLS {
    print_efficiency(RESOURCES.MAX_CPUS)
    ch_versions = Channel.empty()
    ch_local_samples = Channel.fromList(collect_samples(params.braseqtb, params.workflows[params.wf].ext, params.include, params.exclude))
    ...
    if (params.containsKey('accession')) {
        ...
        if (params.accession || params.accessions || params.species) {
            ...
            ch_downloads = NCBIGENOMEDOWNLOAD.out.braseqtb_tools.mix(ch_local_files)
        } else {
...
workflow.onComplete {
    ...
    println """
    braseqtb Tools: `${params.wf} Execution Summary
    ---------------------------
