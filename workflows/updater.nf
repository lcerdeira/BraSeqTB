...
========================================================================================
    ...
    This Nextflow script is really only meant to be used by braseqtb developers. Now we
    can't stop you from using it, but before you do consider if its needed. The datbases
    built in the workflow are already available to you in braseqtb. If there is truely
...
workflow.onComplete {
    ...
    println """
    braseqtb Updater Execution Summary
    ---------------------------
